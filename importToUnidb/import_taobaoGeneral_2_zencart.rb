...
shopid="shop62502950" #yanyangcao
shopid="sionz"  #cocci bag
shopid="z-feel"
...
urlBase="http://#{shopid}.taobao.com/?search=y&orderType=hotsell&categoryName=&viewType=grid&price1=&price2=&scid=0&keyword=&old_starts=&categoryp=&pidvid=&isNew=&ends=&baobei_type=&pageNum="
...
endPageID=ARGV[1].to_i if !ARGV[1].nil?
puts "Confirm again: processing from page #{startPageID} to #{endPageID}"
...
thisPageItemURLArray=TaobaoGeneral.getthisPageItemsArray(ie,thisPageURL)
TaobaoGeneral.handleOnePage(thisPageItemURLArray,x.to_s)
